"""Login page object for the jmsco (哥伦比亚 JMS) system.

Encapsulates login-page selectors and the happy-path login flow. Selectors
are based on the real jmsco UAT environment (Playwright recording). The
...
class LoginPage(BasePage):
    ...
    async def ensure_chinese_language(self) -> None:
        ...
        if await page.is_visible("i"):
            ...
            await page.get_by_text("中文").nth(1).click()
