# jmsmx -- 墨西哥 JMS 系统 WebUI 自动化测试

jmsmx = JMS + MX (墨西哥). 基于 framework 的 WebUI 自动化测试项目,
测试 墨西哥 JMS 系统的登录等功能.
...
`nv
JMSMX_TEST_USERNAME=你的员工编号
JMSMX_TEST_PASSWORD=你的密码
`
...
> **注意**: 仅真实浏览器模式 (JMSMX_REAL_BROWSER=1) 生效, 需可见浏览器
